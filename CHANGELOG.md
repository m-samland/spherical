...
- **Update FITS header for IFS outputs** – Populate the extracted IFS data with meta data about pipeline versions and other useful information to ensure archival usefulness ([@lwelzel](https://github.com/lwelzel), [@m-samland](https://github.com/m-samland)). ([#66](https://github.com/m-samland/spherical/pull/66))
